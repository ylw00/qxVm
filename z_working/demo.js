...
function get_dddd(e) {
    let result = "2.0_" + __g._encrypt(encodeURIComponent(e))
    debugger;
    return result
}
// console.log(encode("f1fa96c714c6752f28b162fda60ded03"));
// // console.log(encode("96a98c8b3a433d47b4d9042303330be2"));
